...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dma_test xil_defaultlib.glbl -o dma_test_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dma_test_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/nas/ei/home/ge42waw/Documents/DMA/linux_dma_tutorila/linux_dma_tutorila.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key dma_test_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dma_test_simv.daidir vcs_lib c.obj)
