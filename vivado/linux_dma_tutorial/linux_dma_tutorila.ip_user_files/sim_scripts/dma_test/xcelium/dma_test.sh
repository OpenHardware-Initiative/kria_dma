#!/bin/bash -f
#**********************************************************************************************************
# Vivado (TM) v2023.1_AR000036820 (64-bit)
#
# Script generated by Vivado on Sun Aug 10 16:34:32 CEST 2025
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : dma_test.sh
...
#
# Usage        : dma_test.sh
#                dma_test.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dma_test.sh [-reset_run]
#                dma_test.sh [-reset_log]
#                dma_test.sh [-help]
#
...
#                script (type 'dma_test.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_14 -libname zynq_ultra_ps_e_vip_v1_0_14 -libname xil_defaultlib -libname lib_cdc_v1_0_2 -libname proc_sys_reset_v5_0_13 -libname lib_pkg_v1_0_2 -libname fifo_generator_v13_2_8 -libname lib_fifo_v1_0_17 -libname lib_srl_fifo_v1_0_2 -libname axi_datamover_v5_1_30 -libname axi_sg_v4_1_16 -libname axi_dma_v7_1_29 -libname xlconstant_v1_1_7 -libname smartconnect_v1_0 -libname axi_register_slice_v2_1_28 -libname xlconcat_v2_1_4 -libname generic_baseblocks_v2_1_0 -libname axi_data_fifo_v2_1_27 -libname axi_protocol_converter_v2_1_28 -libname axi_clock_converter_v2_1_27 -libname blk_mem_gen_v8_4_6 -libname axi_dwidth_converter_v2_1_28 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_14 zynq_ultra_ps_e_vip_v1_0_14 xil_defaultlib lib_cdc_v1_0_2 proc_sys_reset_v5_0_13 lib_pkg_v1_0_2 fifo_generator_v13_2_8 lib_fifo_v1_0_17 lib_srl_fifo_v1_0_2 axi_datamover_v5_1_30 axi_sg_v4_1_16 axi_dma_v7_1_29 xlconstant_v1_1_7 smartconnect_v1_0 axi_register_slice_v2_1_28 xlconcat_v2_1_4 generic_baseblocks_v2_1_0 axi_data_fifo_v2_1_27 axi_protocol_converter_v2_1_28 axi_clock_converter_v2_1_27 blk_mem_gen_v8_4_6 axi_dwidth_converter_v2_1_28)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "dma_test.sh - Script generated by export_simulation (Vivado v2023.1_AR000036820 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dma_test.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"$ref_dir/../../../../linux_dma_tutorila.gen/sources_1/bd/dma_test/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../linux_dma_tutorila.gen/sources_1/bd/dma_test/ipshared/f805/hdl" +incdir+"$ref_dir/../../../../linux_dma_tutorila.gen/sources_1/bd/dma_test/ipshared/f0b6/hdl/verilog" +incdir+"$ref_dir/../../../../linux_dma_tutorila.gen/sources_1/bd/dma_test/ipshared/66be/hdl/verilog" +incdir+"../../../../linux_dma_tutorila.gen/sources_1/bd/dma_test/ipshared/ec67/hdl" +incdir+"../../../../linux_dma_tutorila.gen/sources_1/bd/dma_test/ipshared/f805/hdl" +incdir+"../../../../linux_dma_tutorila.gen/sources_1/bd/dma_test/ipshared/f0b6/hdl/verilog" +incdir+"../../../../linux_dma_tutorila.gen/sources_1/bd/dma_test/ipshared/66be/hdl/verilog" +incdir+"/nfs/tools/xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvhdl -work axi_sg_v4_1_16 -V93 $xmvhdl_opts \
  "../../../../linux_dma_tutorila.gen/sources_1/bd/dma_test/ipshared/85d0/hdl/axi_sg_v4_1_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvhdl -work axi_dma_v7_1_29 -V93 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.dma_test xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.dma_test -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/nas/ei/home/ge42waw/Documents/DMA/linux_dma_tutorila/linux_dma_tutorila.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log dma_test_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dma_test.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dma_test.sh [-help]\n\
Usage: dma_test.sh [-step]\n\
Usage: dma_test.sh [-lib_map_path]\n\
Usage: dma_test.sh [-reset_run]\n\
Usage: dma_test.sh [-reset_log]\n\
Usage: dma_test.sh [-keep_index]\n\
Usage: dma_test.sh [-noclean_files]\n\n\
